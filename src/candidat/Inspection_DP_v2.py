...
class Control_Param():
    ...
    def control_time(self,msg):
        ...
        ######################################################################## Axis calculation #########################################################################
                ...
                self.e_x , self.threshold_length = bound_length(self.rel_x, self.rel_y, self.rel_yaw, math.pi*50/180, self.ds + self.x_bias)
        ...
        ########################################################################## 1st control ##########################################################################
                    ...
                    if self.switch == 1:
                        ...
                        if self.e_x < 0:
                            ...
                            self.desired_yaw = self.yaw_e - (self.delta_sp*abs(self.e_x)/(self.ds) + self.delta_default_n)
...
def main():
    ...
    rospy.Subscriber('/dp_bias' , Float64, param.sub_x_bias) 
