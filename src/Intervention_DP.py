...
class Control_Param():
    ...
    def dock(self,msg):
        ...
        if self.dock_switch != 6 and self.before_dock_switch == 6:
            self.found_heading = 0
    ...
    def control_time(self,msg):
        ...
        ########################################################################## wpt control ##########################################################################
                if math.sqrt(self.e_y*self.e_y + self.e_x*self.e_x) > self.wpt_distance:
        ...
        ########################################################################## 1st control ##########################################################################
                elif math.sqrt(self.e_y*self.e_y + self.e_x*self.e_x) < self.wpt_distance :
                    if self.switch == 1:
                        # if self.e_x > 0:
        ...
        ########################################################################## 2nd control ##########################################################################
                        ...
                        if self.con_time > 1:
                            ...
                            #################################################### yaw_e -> T_con #################################################################
                            if abs(self.desired_yaw) > math.pi*30/180:
                                self.T_con = 0 
                            #####################################################################################################################################
