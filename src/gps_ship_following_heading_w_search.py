...
class Control_Param():
    def __init__(self):
        ...
        self.heading_search_distance = 45.0 #############
    ...
    def Target_Imu_pose_sub(self,data):
        ...
        self.Target_vessel_pose_yaw = quat[2] #+ math.pi

        if self.Target_vessel_pose_yaw < -math.pi:
            self.Target_vessel_pose_yaw += 2 * 3.141592
        #print(self.Target_vessel_pose_yaw)
        if self.Target_vessel_pose_yaw > math.pi:
            self.Target_vessel_pose_yaw -= 2 * 3.141592
        # print("T he : ",self.Target_vessel_pose_yaw)
